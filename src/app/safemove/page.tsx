          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-lg border border-gray-100 max-w-2xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="flex-1 px-4 py-3 rounded-md border border-gray-200 focus:outline-none focus:border-navy-base focus:ring-1 focus:ring-navy-base text-gray-900"
                required
              />
              <button 
                type="submit"
                className="bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 px-6 rounded-md transition-colors"
              >
