        ...
        <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-slate-700 text-base leading-relaxed">
            ...
            <section className="space-y-3 pt-4">
              ...
              <p>
                Property Hub Ghana does not use invasive third-party ad trackers or cross-site behavioral marketing cookies. The external services with browser storage footprints are functional infrastructure partners required to operate authentication and SMS/WhatsApp notification delivery, plus Google Analytics (first-party cookies only, never used for advertising). We do run Google Analytics in aggregate, privacy-friendly mode to understand general page performance and traffic levels — it does not track you across other websites and is never used for advertising.
              </p>
            </section>
