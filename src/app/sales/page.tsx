...
const salesListings = [
  {
    ...
    title: "Eco-Haven Estate Villa",
    price: "₵4,500,000",
    propertyType: "House",
    dimensions: "3,400 sqft / 0.15 Acre",
  ...
  },
  {
    ...
    title: "The Apex Executive Townhouse",
    price: "₵2,800,000",
    propertyType: "House",
  ...
  },
  {
    ...
    title: "Oyarifa Prime Land Plot",
    price: "₵350,000",
    propertyType: "Land",
    dimensions: "70x100 ft (Standard Plot)",
    ...
    <div className="w-full min-h-screen bg-surface-primary pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row gap-8 items-start">
        ...
        <aside className="w-full md:w-72 flex-shrink-0 bg-white rounded-md shadow-ambient border border-gray-100 p-6 sticky top-24">
          ...
          {/* Property Category Macro-Toggles */}
          <div className="mb-8">
            <h3 className="text-sm font-semibold text-navy-base mb-4">Property Type</h3>
            <div className="flex bg-surface-primary p-1 rounded-sm border border-gray-200">
              <button className="flex-1 py-2 text-sm font-semibold text-white bg-navy-base rounded-sm shadow-sm transition-all">
                Houses
              </button>
              <button className="flex-1 py-2 text-sm font-semibold text-gray-500 hover:text-navy-base transition-all rounded-sm">
                Land/Plots
              </button>
            </div>
          </div>
        ...
        <main className="flex-1 w-full">
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-500 font-medium">Showing 42 properties</p>
              ...
              <div key={prop.id} className="bg-white rounded-md overflow-hidden border border-gray-100 shadow-ambient hover:shadow-lg transition-shadow duration-300 flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  {prop.propertyType === 'Land' && (
                    <div className="my-4 pt-4 border-t border-gray-50 flex items-center gap-4 text-xs text-gray-600">
                      <span className="flex items-center gap-1 font-semibold text-navy-base">Vacant Plot</span>
                    </div>
                  )}
                  ...
                  <div className="mt-auto bg-navy-base p-4 rounded-sm border border-navy-light flex flex-col gap-2 mb-4 text-white">
                    <div className="flex items-end justify-between">
                      ...
                      <div className="text-xl font-extrabold text-white">{prop.price}</div>
                    </div>
