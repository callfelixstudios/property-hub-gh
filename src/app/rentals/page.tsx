                  ...
                  <div className="mt-auto bg-surface-primary p-3 rounded-sm border border-gray-100 space-y-1.5 mb-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-extrabold text-navy-base">
                        {prop.currency === 'USD' ? '$' : 'GH₵'}{prop.rawPrice.toLocaleString()}
                    ...
                    {prop.serviceChargeNum > 0 && (
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <span className="font-semibold text-slate-700">
                          {prop.currency === 'USD' ? '$' : 'GH₵'}{prop.serviceChargeNum.toLocaleString()}
                    ...
                    {prop.rentAdvanceMonths > 0 && (
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <span className="font-semibold text-slate-700 flex items-center gap-1">
                          {prop.currency === 'USD' ? '$' : 'GH₵'}{prop.computedUpfront.toLocaleString()}
